...
root = './IDR_image'
name = 'idr0016-wawer-bioactivecompoundprofiling'
...
print('  Channel selection is done at dataset loading / data loader level')
...
print('  Channel selection (keep only nuclei, ER, F-actin channels) handled downstream.')
