...
root = './IDR_image'
name = 'idr0129-georgi-rhinovirus'
path = os.path.join(root, name)

print(f'Processing {name}...')
print('  Dataset: HeLa Ohio cells infected with Rhinovirus, fluorescence microscopy')
print('  Channels (both used): Hoechst + virus-GFP')
