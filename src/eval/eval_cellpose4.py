...
def eval_subsets(root, dataset_name, seed=0, ntrain=1,
    ...
    if save_results:
        ...
        save_dir = f"./data/all/predicted_masks_per_dataset/{dataset_name}_cellpose4"
    ...
    result_txt = '/data/linshan/Cellpose_data/all/eval_results_cellpose4.txt'
...
if __name__ == "__main__":
    ...
    if args.save_results and len(all_dataset_names) > 0:
        ...
        mtype = "sam" if transformer else "cyto3"
        excel_path = f'/data/linshan/Cellpose_data/all/cellpose4.xlsx'
