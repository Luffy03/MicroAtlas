"""
Cell type identification module using known mouse colon cell markers.

Assigns cell types to segmented cells based on gene expression
signatures of known mouse colon cell types.
"""
...
class CellTyper:
    ...
    Uses a panel of known mouse colon cell type markers to compute
    ...
    def __init__(self, cell_markers: Optional[Dict[str, List[str]]] = None):
        ...
        Args:
            cell_markers: Dict mapping cell_type_name -> list of marker gene names.
                          Defaults to config.COLON_CELL_MARKERS.
        """
        self.markers = cell_markers or config.COLON_CELL_MARKERS
